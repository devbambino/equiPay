...
export default function ManagePage() {
  ...
  const deeplinkTransfer = `https://minipay.opera.com/transfer?to=&amount=&token=`;
  const deeplinkDeposit = `https://minipay.opera.com/add_cash`;
  const deeplinkWithdraw = `https://minipay.opera.com/withdraw?token=`;
      ...
      <div className="w-full max-w-2xl mx-auto bg-gray-800 p-8 rounded-lg shadow-lg space-y-8 text-center">
        <div>
          ...
          <div className="mb-6 text-lg text-gray-300">
            Total (all tokens): <span className="font-bold text-yellow-300">{totalBalance.toFixed(2)}</span>
          </div> */}
          {/* Balances grid */}
          {loadingBalances ? (
